...
def nn_p3p4p5(img_input=None,offset=True, num_scale=1, trainable=False):
    ...
    Pp4L2 = L2Normalization(gamma_init=10, name='P4norm_1')(Pp4)
    Pp6L2 = L2Normalization(gamma_init=10, name='P6norm')(Pp6)
    P3_1 = Add(name="fpn_p3add")([Pp4L2,Conv2D(256, (1, 1), name='fpn_c3p3')(C3)])
    P3 = Add(name="fpn_p3add_2")([Pp6L2,Conv2D(256, (1, 1), name='fpn_c3p3_2')(P3_1)])
    ...
    conc =Concatenate(axis=-1)([P5_up,P4_up,P3_up])
