...
def nn_p3p4p5(img_input=None,offset=True, num_scale=1, trainable=False):
    ...
    Pp4_1 = L2Normalization(gamma_init=10, name='P4norm_1')(Pp4)
    Pp6_1 = L2Normalization(gamma_init=10, name='P6norm')(Pp6)
    P3_1 = Add(name="fpn_p3add")([Pp4_1,Conv2D(256, (1, 1), name='fpn_c3p3')(C3)])
    P3 = Add(name="fpn_p3add_2")([Pp6_1,Conv2D(256, (1, 1), name='fpn_c3p3_2')(P3_1)])
    ...
    Pp3_1 = L2Normalization(gamma_init=10, name='P3norm_1')(Pp3)
    Pp6_2 = L2Normalization(gamma_init=10, name='P6_1norm')(Pp6)

    P2_1 = Add(name="fpn_p2add")([Pp3_1,Conv2D(256, (1, 1), name='fpn_c2p2')(C2)])
    P2 = Add(name="fpn_p2add_2")([Pp6_2,Conv2D(256, (1, 1), name='fpn_c2p2_2')(P2_1)])
    '''
