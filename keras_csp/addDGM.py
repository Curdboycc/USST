...
def nn_p3p4p5(img_input=None,offset=True, num_scale=1, trainable=False):
    ...
    stage6 = Convolution2D(256, (1, 1), padding='same', kernel_initializer='glorot_normal', name='feat6',
                         trainable=trainable)(stage6)
    ...
    P6_up = Deconvolution2D(256, kernel_size=4, strides=4, padding='same',
                            kernel_initializer='glorot_normal', name='P6up', trainable=trainable)(stage6)
    ...
    P6_up = L2Normalization(gamma_init=10, name='P6norm')(P6_up)
    conc = Concatenate(axis=-1)([P2_up, P3_up, P4_up, P5_up, P6_up])
