...
def nn_p3p4p5(img_input=None,offset=True, num_scale=1, trainable=False):
    ...
    P4_1 = Add(name="fpn_p4add")([P5_up,Conv2D(256, (1, 1), name='fpn_c4p4')(C4)])
    P4 = Add(name="fpn_p4_2add")([P6_up,Conv2D(256, (1, 1), name='fpn_c4p4_2')(P4_1)])
    ...
    Pp4 = L2Normalization(gamma_init=10, name='P4norm')(Pp4)
    Pp6 = L2Normalization(gamma_init=10, name='P6norm')(Pp6)
